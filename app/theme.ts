...
export const darkTokens: ThemeTokens = {
  ...
  surface:       "oklch(15% 0.010 55)",
  surface2:      "oklch(20% 0.012 55)",
  surface3:      "oklch(26% 0.013 55)",
  headerBg:      "oklch(7.5% 0.006 55)",
  border:        "oklch(30% 0.012 55)",
  border2:       "oklch(38% 0.015 55)",
  text:          "oklch(91% 0.007 75)",
  textdim:       "oklch(56% 0.014 75)",
  textfaint:     "oklch(38% 0.010 75)",
  ...
  drop:          "oklch(22% 0.06 248)",
  slotBg:        "oklch(12% 0.006 55)",
  slotOkBg:      "oklch(14% 0.09 145)",
  slotBadBg:     "oklch(13% 0.09 25)",
  bgGradientColor: "oklch(20% 0.05 248 / 0.55)",
};

export const lightTokens: ThemeTokens = {
  bg:            "oklch(97% 0.004 75)",
  surface:       "oklch(100% 0 0)",
  surface2:      "oklch(94% 0.005 75)",
  surface3:      "oklch(88% 0.007 75)",
  headerBg:      "oklch(96% 0.004 75)",
  border:        "oklch(83% 0.008 75)",
  border2:       "oklch(72% 0.012 75)",
  text:          "oklch(15% 0.010 55)",
  textdim:       "oklch(42% 0.012 75)",
  textfaint:     "oklch(62% 0.010 75)",
  ...
  slotBg:        "oklch(94% 0.004 75)",
  slotOkBg:      "oklch(90% 0.05 145)",
  slotBadBg:     "oklch(91% 0.04 25)",
  bgGradientColor: "oklch(88% 0.06 248 / 0.25)",
};
